...
class Tag
{
	...
	/**
	 * @param \StoreEngine\Mpdf\Mpdf $mpdf
	 * @param \StoreEngine\Mpdf\Cache $cache
	 * @param \StoreEngine\Mpdf\CssManager $cssManager
	 * @param \StoreEngine\Mpdf\Form $form
	 * @param \StoreEngine\Mpdf\Otl $otl
	 * @param \StoreEngine\Mpdf\TableOfContents $tableOfContents
	 * @param \StoreEngine\Mpdf\SizeConverter $sizeConverter
	 * @param \StoreEngine\Mpdf\Color\ColorConverter $colorConverter
	 * @param \StoreEngine\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \StoreEngine\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
	 ...
	 * @return \StoreEngine\Mpdf\Tag\Tag
	 */
	...
	public static function getTagClassName($tag)
	{
		...
		$className = 'StoreEngine\Mpdf\Tag\\';
