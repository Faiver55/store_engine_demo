...
namespace StoreEngine\Mpdf\PsrHttpMessageShim;

use StoreEngine\Psr\Http\Message\StreamInterface;
use StoreEngine\Psr\Http\Message\ResponseInterface;
use StoreEngine\Psr\Http\Message\MessageInterface;
 ...
 */
class Response implements \StoreEngine\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \StoreEngine\Psr\Http\Message\StreamInterface */
	private $stream;
