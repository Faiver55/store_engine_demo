...
trait Request
{
     ...
     *
     * @throws \StoreEngine\Stripe\Exception\InvalidArgumentException if $params exists and is not an array
     */
    protected static function _validateParams($params = null)
    {
        if ($params && !\is_array($params)) {
            $message = 'You must pass an array as the first argument to Stripe API '
                ...
                . "would be: \"StoreEngine\\Stripe\\Charge::create(['amount' => 100, "
                . "'currency' => 'usd', 'source' => 'tok_1234'])\")";

            throw new \StoreEngine\Stripe\Exception\InvalidArgumentException($message);
        }
    }
    ...
    /**
     * @param string $url URL for the request
     * @param class-string< \Stripe\SearchResult|\StoreEngine\Stripe\Collection > $resultClass indicating what type of paginated result is returned
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection|\StoreEngine\Stripe\SearchResult
     */
    protected static function _requestPage($url, $resultClass, $params = null, $options = null, $usage = [])
    {
        ...
        if (!($obj instanceof $resultClass)) {
            throw new \StoreEngine\Stripe\Exception\UnexpectedValueException(
    ...
    {
        $opts = \StoreEngine\Stripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \StoreEngine\Stripe\ApiRequestor($opts->apiKey, $baseUrl);
