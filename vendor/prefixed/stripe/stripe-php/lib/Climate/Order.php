...
namespace StoreEngine\Stripe\Climate;
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $beneficiary
 ...
 * @property \StoreEngine\Stripe\StripeObject[] $delivery_details Details about the delivery of carbon removal for this order.
 ...
 * @property string|\StoreEngine\Stripe\Climate\Product $product Unique ID for the Climate <code>Product</code> this order is purchasing.
 ...
 */
class Order extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Climate\Order the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Climate\Order> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Climate\Order
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Climate\Order the updated resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Climate\Order the canceled order
     */
