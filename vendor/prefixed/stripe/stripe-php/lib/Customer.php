 ...
 * @property null|string|\StoreEngine\Stripe\Account|\StoreEngine\Stripe\BankAccount|\StoreEngine\Stripe\Card|\StoreEngine\Stripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you use payment methods created through the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property null|\StoreEngine\Stripe\Collection<\Stripe\Account|\StoreEngine\Stripe\BankAccount|\StoreEngine\Stripe\Card|\StoreEngine\Stripe\Source> $sources The customer's payment sources, if any.
 * @property null|\StoreEngine\Stripe\Collection<\Stripe\Subscription> $subscriptions The customer's current subscriptions, if any.
 * @property null|\StoreEngine\Stripe\StripeObject $tax
 ...
 * @property null|\StoreEngine\Stripe\Collection<\Stripe\TaxId> $tax_ids The customer's tax IDs.
 * @property null|string|\StoreEngine\Stripe\TestHelpers\TestClock $test_clock ID of the test clock that this customer belongs to.
 *
 * @license MIT
...
class Customer extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Customer the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Customer the deleted resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Customer> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Customer the updated resource
     */
     ...
     * @param null|array|string $opts
     *
     * @return \StoreEngine\Stripe\Customer the updated customer
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\PaymentMethod> list of payment methods
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\PaymentMethod the retrieved payment method
     */
    public function retrievePaymentMethod($payment_method, $params = null, $opts = null)
    {
        ...
        $obj = \StoreEngine\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\SearchResult<\Stripe\Customer> the customer search results
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\CustomerBalanceTransaction> the list of customer balance transactions
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\CustomerBalanceTransaction
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\CustomerCashBalanceTransaction> the list of customer cash balance transactions
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\CustomerCashBalanceTransaction
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\BankAccount|\StoreEngine\Stripe\Card|\StoreEngine\Stripe\Source> the list of payment sources (BankAccount, Card or Source)
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\BankAccount|\StoreEngine\Stripe\Card|\StoreEngine\Stripe\Source
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\CashBalance
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\TaxId> the list of tax ids
     */
