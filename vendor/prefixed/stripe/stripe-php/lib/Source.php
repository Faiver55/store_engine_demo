 ...
 * @property null|\StoreEngine\Stripe\StripeObject $ach_credit_transfer
 * @property null|\StoreEngine\Stripe\StripeObject $ach_debit
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $code_verification
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property null|\StoreEngine\Stripe\StripeObject $p24
 * @property null|\StoreEngine\Stripe\StripeObject $receiver
 * @property null|\StoreEngine\Stripe\StripeObject $redirect
 * @property null|\StoreEngine\Stripe\StripeObject $sepa_credit_transfer
 * @property null|\StoreEngine\Stripe\StripeObject $sepa_debit
 * @property null|\StoreEngine\Stripe\StripeObject $sofort
 * @property null|\StoreEngine\Stripe\StripeObject $source_order
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $three_d_secure
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $wechat
 *
 * @license MIT
...
class Source extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Source the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Source
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Source the updated resource
     */
     ...
     * @param null|array|string $opts
     *
     * @throws \StoreEngine\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Source the detached source
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\SourceTransaction> list of source transactions
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Source the verified source
     */
