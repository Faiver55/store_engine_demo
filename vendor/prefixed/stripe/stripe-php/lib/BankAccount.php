 ...
 * @property null|string|\StoreEngine\Stripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\StoreEngine\Stripe\Customer $customer The ID of the customer that the bank account is associated with.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for the bank account</a>, including what information needs to be collected, and by when.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $requirements Information about the requirements for the bank account, including what information needs to be collected.
...
class BankAccount extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\BankAccount the deleted resource
     */
