 ...
 * @property \StoreEngine\Stripe\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \StoreEngine\Stripe\StripeObject $verification_fields
 *
 * @license MIT
...
class CountrySpec extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\CountrySpec> of ApiResources
     */
