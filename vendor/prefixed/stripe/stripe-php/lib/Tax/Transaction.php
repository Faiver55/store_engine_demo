 ...
 * @property \StoreEngine\Stripe\StripeObject $customer_details
 * @property null|\StoreEngine\Stripe\Collection<\Stripe\Tax\TransactionLineItem> $line_items The tax collected or refunded, by line item.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $reversal If <code>type=reversal</code>, contains information about what was reversed.
 * @property null|\StoreEngine\Stripe\StripeObject $ship_from_details The details of the ship from location, such as the address.
 * @property null|\StoreEngine\Stripe\StripeObject $shipping_cost The shipping cost details for the transaction.
...
class Transaction extends \StoreEngine\Stripe\ApiResource
{
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Tax\Transaction the created transaction
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Tax\TransactionLineItem> list of transaction line items
     */
