 ...
 * @property null|\StoreEngine\Stripe\Collection<\Stripe\Tax\CalculationLineItem> $line_items The list of items the customer is purchasing.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $shipping_cost The shipping cost details for the calculation.
 ...
 * @property \StoreEngine\Stripe\StripeObject[] $tax_breakdown Breakdown of individual tax amounts that add up to the total.
 ...
 */
class Calculation extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Tax\Calculation the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Tax\CalculationLineItem> list of calculation line items
     */
