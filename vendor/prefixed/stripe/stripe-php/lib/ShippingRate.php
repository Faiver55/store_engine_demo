 ...
 * @property null|\StoreEngine\Stripe\StripeObject $delivery_estimate The estimated range for how long shipping will take, meant to be displayable to the customer. This will appear on CheckoutSessions.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $fixed_amount
 ...
 * @property null|string|\StoreEngine\Stripe\TaxCode $tax_code A <a href="https://stripe.com/docs/tax/tax-categories">tax code</a> ID. The Shipping tax code is <code>txcd_92010001</code>.
...
class ShippingRate extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\ShippingRate the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\ShippingRate> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\ShippingRate the updated resource
     */
