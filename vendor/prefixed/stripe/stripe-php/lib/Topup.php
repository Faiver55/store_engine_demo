 ...
 * @property null|string|\StoreEngine\Stripe\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this top-up on your account balance. May not be specified depending on status of top-up.
 ...
 * @property null|\StoreEngine\Stripe\Source $source The source field is deprecated. It might not always be present in the API response.
...
class Topup extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Topup the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Topup> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Topup the updated resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Topup the canceled topup
     */
