 ...
 * @property null|string|\StoreEngine\Stripe\Customer $customer The customer that this card belongs to. This attribute will not be in the card object if the card belongs to an account or recipient instead.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $networks
...
class Card extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Card the deleted resource
     */
