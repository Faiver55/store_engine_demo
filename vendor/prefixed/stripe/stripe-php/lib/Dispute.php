 ...
 * @property \StoreEngine\Stripe\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Stripe account as a result of this dispute.
 * @property string|\StoreEngine\Stripe\Charge $charge ID of the charge that's disputed.
 ...
 * @property \StoreEngine\Stripe\StripeObject $evidence_details
 ...
 * @property null|string|\StoreEngine\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\StoreEngine\Stripe\StripeObject $payment_method_details
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Dispute> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Dispute
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Dispute the updated resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Dispute the closed dispute
     */
