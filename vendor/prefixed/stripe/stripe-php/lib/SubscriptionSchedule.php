 ...
 * @property null|string|\StoreEngine\Stripe\Application $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\StoreEngine\Stripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \StoreEngine\Stripe\StripeObject $default_settings
 ...
 * @property \StoreEngine\Stripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\StoreEngine\Stripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\StoreEngine\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 *
 * @license MIT
...
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\SubscriptionSchedule the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\SubscriptionSchedule> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\SubscriptionSchedule
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\SubscriptionSchedule the updated resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\SubscriptionSchedule the released subscription schedule
     */
