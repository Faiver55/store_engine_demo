 ...
 * @property null|string|\StoreEngine\Stripe\File $card_logo The file for the card logo to use with physical bundles that support card logos. Must have a <code>purpose</code> value of <code>issuing_logo</code>.
 * @property null|\StoreEngine\Stripe\StripeObject $carrier_text Hash containing carrier text, for use with physical bundles that support carrier text.
 ...
 * @property string|\StoreEngine\Stripe\Issuing\PhysicalBundle $physical_bundle The physical bundle object belonging to this personalization design.
 * @property \StoreEngine\Stripe\StripeObject $preferences
 * @property \StoreEngine\Stripe\StripeObject $rejection_reasons
 * @property string $status Whether this personalization design can be used to create cards.
 *
 * @license MIT
 * Modified by kodezen on 22-July-2025 using {@see https://github.com/BrianHenryIE/strauss}.
 */
class PersonalizationDesign extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Issuing\PersonalizationDesign the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Issuing\PersonalizationDesign> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Issuing\PersonalizationDesign the updated resource
     */
