 ...
 * @property null|string|\StoreEngine\Stripe\Issuing\PersonalizationDesign $personalization_design The personalization design object belonging to this card.
 * @property null|string|\StoreEngine\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\StoreEngine\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\StoreEngine\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \StoreEngine\Stripe\StripeObject $spending_controls
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 *
 * @license MIT
 * Modified by kodezen on 22-July-2025 using {@see https://github.com/BrianHenryIE/strauss}.
 */
class Card extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Issuing\Card the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Issuing\Card> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Issuing\Card the updated resource
     */
