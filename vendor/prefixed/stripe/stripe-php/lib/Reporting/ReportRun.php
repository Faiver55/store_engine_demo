...
namespace StoreEngine\Stripe\Reporting;
 ...
 * @property \StoreEngine\Stripe\StripeObject $parameters
 ...
 * @property null|\StoreEngine\Stripe\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Reporting\ReportRun the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Reporting\ReportRun> of ApiResources
     */
