 ...
 * @property \StoreEngine\Stripe\StripeObject $customer_mapping
 * @property \StoreEngine\Stripe\StripeObject $default_aggregation
 ...
 * @property \StoreEngine\Stripe\StripeObject $value_settings
 *
 * @license MIT
 * Modified by kodezen on 22-July-2025 using {@see https://github.com/BrianHenryIE/strauss}.
 */
class Meter extends \StoreEngine\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';

    use \StoreEngine\Stripe\ApiOperations\NestedResource;
     ...
     *
     * @return \StoreEngine\Stripe\Billing\Meter the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Billing\Meter> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Billing\Meter the updated resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Billing\Meter the deactivated meter
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Billing\Meter the reactivated meter
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Billing\MeterEventSummary> the list of meter event summaries
     */
