 ...
 * @property null|\StoreEngine\Stripe\StripeObject $additional_tos_acceptances
 * @property null|\StoreEngine\Stripe\StripeObject $address
 * @property null|\StoreEngine\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\StoreEngine\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|\StoreEngine\Stripe\StripeObject $dob
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for this person</a>, including what information needs to be collected, and by when.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $registered_address
 * @property null|\StoreEngine\Stripe\StripeObject $relationship
 * @property null|\StoreEngine\Stripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $verification
 *
 * @license MIT
...
class Person extends ApiResource
{
     ...
     *
     * @throws \StoreEngine\Stripe\Exception\BadMethodCallException
     */
