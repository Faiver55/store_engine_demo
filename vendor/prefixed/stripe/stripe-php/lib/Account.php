 ...
 * @property null|\StoreEngine\Stripe\StripeObject $business_profile Business information about the account.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $capabilities
 * @property null|bool $charges_enabled Whether the account can process charges.
 * @property null|\StoreEngine\Stripe\StripeObject $company
 * @property null|\StoreEngine\Stripe\StripeObject $controller
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $requirements
 * @property null|\StoreEngine\Stripe\StripeObject $settings Options for customizing how the account functions within Stripe.
 * @property null|\StoreEngine\Stripe\StripeObject $tos_acceptance
...
class Account extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Account the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Account the deleted resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Account> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Account the updated resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Account
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\StripeObject object containing the response from the API
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Account the rejected account
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Capability> the list of capabilities
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Capability
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\BankAccount|\StoreEngine\Stripe\Card> the list of external accounts (BankAccount or Card)
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\BankAccount|\StoreEngine\Stripe\Card
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\LoginLink
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Person> the list of persons
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Person
     */
