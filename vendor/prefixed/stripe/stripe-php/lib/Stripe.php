...
class Stripe
{
    ...
    public static $apiVersion = \StoreEngine\Stripe\Util\ApiVersion::CURRENT;
    ...
    /**
     * @param \StoreEngine\Psr\Log\LoggerInterface|Util\LoggerInterface $logger the logger to which the library
