 ...
 * @property string|\StoreEngine\Stripe\File $file The file object this link points to.
...
class FileLink extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\FileLink the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\FileLink> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\FileLink
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\FileLink the updated resource
     */
