 ...
 * @property null|\StoreEngine\Stripe\StripeObject $account_holder The account holder for whom accounts are collected in this session.
 * @property \StoreEngine\Stripe\Collection<\Stripe\FinancialConnections\Account> $accounts The accounts that were collected as part of this Session.
 * @property string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|\StoreEngine\Stripe\StripeObject $filters
...
class Session extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\FinancialConnections\Session the created resource
     */
