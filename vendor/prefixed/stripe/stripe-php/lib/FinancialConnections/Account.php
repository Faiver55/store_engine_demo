 ...
 * @property null|\StoreEngine\Stripe\StripeObject $account_holder The account holder that this account belongs to.
 * @property null|\StoreEngine\Stripe\StripeObject $balance The most recent information about the account's balance.
 * @property null|\StoreEngine\Stripe\StripeObject $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|string|\StoreEngine\Stripe\FinancialConnections\AccountOwnership $ownership The most recent information about the account's owners.
 * @property null|\StoreEngine\Stripe\StripeObject $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 *
 * @license MIT
 * Modified by kodezen on 22-July-2025 using {@see https://github.com/BrianHenryIE/strauss}.
 */
class Account extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\FinancialConnections\Account> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\FinancialConnections\Account the disconnected account
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\FinancialConnections\AccountOwner> list of account owners
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\FinancialConnections\Account the refreshed account
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\FinancialConnections\Account the subscribed account
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\FinancialConnections\Account the unsubscribed account
     */
