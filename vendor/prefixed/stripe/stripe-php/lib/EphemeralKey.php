...
class EphemeralKey extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\EphemeralKey the deleted resource
     */
     ...
     * @param null|array|string $opts
     *
     * @throws \StoreEngine\Stripe\Exception\InvalidArgumentException if stripe_version is missing
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\EphemeralKey the created key
     */
