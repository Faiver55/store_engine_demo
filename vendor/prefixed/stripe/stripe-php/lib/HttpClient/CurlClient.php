...
use StoreEngine\Stripe\Exception;
use StoreEngine\Stripe\Stripe;
use StoreEngine\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \StoreEngine\Stripe\Util\RandomGenerator */
     ...
     * @param null|\StoreEngine\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\StoreEngine\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
