 ...
 * @property null|string|\StoreEngine\Stripe\Product $product The product whose pricing this plan determines.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $transform_usage Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
...
class Plan extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Plan the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Plan the deleted resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Plan> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Plan the updated resource
     */
