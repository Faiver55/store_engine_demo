 ...
 * @property null|string|\StoreEngine\Stripe\Customer $customer ID of the customer.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\StoreEngine\Stripe\StripeObject $owner The account or customer the tax ID belongs to.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $verification Tax ID verification information.
 *
 * @license MIT
...
class TaxId extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\TaxId the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\TaxId the deleted resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\TaxId> of ApiResources
     */
