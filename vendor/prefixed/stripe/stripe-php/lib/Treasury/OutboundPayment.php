 ...
 * @property null|\StoreEngine\Stripe\StripeObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\StoreEngine\Stripe\StripeObject $end_user_details Details about the end user.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $tracking_details Details about network-specific tracking information if available.
 * @property string|\StoreEngine\Stripe\Treasury\Transaction $transaction The Transaction associated with this object.
 *
 * Modified by kodezen on 22-July-2025 using {@see https://github.com/BrianHenryIE/strauss}.
 */
class OutboundPayment extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Treasury\OutboundPayment the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Treasury\OutboundPayment> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Treasury\OutboundPayment
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Treasury\OutboundPayment the canceled outbound payment
     */
