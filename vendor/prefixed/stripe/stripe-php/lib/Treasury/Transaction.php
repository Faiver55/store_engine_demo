 ...
 * @property \StoreEngine\Stripe\StripeObject $balance_impact Change to a FinancialAccount's balance
 ...
 * @property null|\StoreEngine\Stripe\Collection<\Stripe\Treasury\TransactionEntry> $entries A list of TransactionEntries that are part of this Transaction. This cannot be expanded in any list endpoints.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $flow_details Details of the flow that created the Transaction.
...
class Transaction extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Treasury\Transaction> of ApiResources
     */
