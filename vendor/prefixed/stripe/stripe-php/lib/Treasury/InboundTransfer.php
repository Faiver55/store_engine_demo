 ...
 * @property null|\StoreEngine\Stripe\StripeObject $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property \StoreEngine\Stripe\StripeObject $linked_flows
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property null|string|\StoreEngine\Stripe\Treasury\Transaction $transaction The Transaction associated with this object.
 *
 * Modified by kodezen on 22-July-2025 using {@see https://github.com/BrianHenryIE/strauss}.
 */
class InboundTransfer extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Treasury\InboundTransfer the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Treasury\InboundTransfer> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Treasury\InboundTransfer the canceled inbound transfer
     */
