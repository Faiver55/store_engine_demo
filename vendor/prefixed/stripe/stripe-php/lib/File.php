 ...
 * @property null|\StoreEngine\Stripe\Collection<\Stripe\FileLink> $links A list of <a href="https://stripe.com/docs/api#file_links">file links</a> that point at this file.
...
class File extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\File> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\File
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\File the created file
     */
    public static function create($params = null, $opts = null)
    {
        ...
        $flatParams = \array_column(\StoreEngine\Stripe\Util\Util::flattenParams($params), 1, 0);
