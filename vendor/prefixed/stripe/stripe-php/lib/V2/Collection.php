 ...
 */
class Collection extends \StoreEngine\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';

    use \StoreEngine\Stripe\ApiOperations\Request;
    ...
    {
        return \StoreEngine\Stripe\Stripe::$apiBase;
    }
    ...
    /**
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException
     *
    ...
    public function autoPagingIterator()
    {
        ...
        while (true) {
            ...
            $obj = \StoreEngine\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
