...
namespace StoreEngine\Stripe\V2;

/**
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value of the object field.
 * @property null|\StoreEngine\Stripe\StripeObject $amazon_eventbridge Amazon EventBridge configuration.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $metadata Metadata.
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $status_details Additional information about event destination status.
 * @property string $type Event destination type.
 * @property int $updated Time at which the object was last updated.
 * @property null|\StoreEngine\Stripe\StripeObject $webhook_endpoint Webhook endpoint configuration.
 *
 * @license MIT
 * Modified by kodezen on 22-July-2025 using {@see https://github.com/BrianHenryIE/strauss}.
 */
class EventDestination extends \StoreEngine\Stripe\ApiResource
{
