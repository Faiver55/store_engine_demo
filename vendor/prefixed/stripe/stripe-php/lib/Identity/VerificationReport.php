 ...
 * @property null|\StoreEngine\Stripe\StripeObject $document Result from a document check
 * @property null|\StoreEngine\Stripe\StripeObject $email Result from a email check
 * @property null|\StoreEngine\Stripe\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\StoreEngine\Stripe\StripeObject $options
 * @property null|\StoreEngine\Stripe\StripeObject $phone Result from a phone check
 * @property null|\StoreEngine\Stripe\StripeObject $selfie Result from a selfie check
 ...
 */
class VerificationReport extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Identity\VerificationReport> of ApiResources
     */
