...
class InvoiceRenderingTemplate extends ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\InvoiceRenderingTemplate> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\InvoiceRenderingTemplate
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\InvoiceRenderingTemplate the archived invoice rendering template
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\InvoiceRenderingTemplate the unarchived invoice rendering template
     */
