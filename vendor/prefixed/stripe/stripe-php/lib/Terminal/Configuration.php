 ...
 * @property null|\StoreEngine\Stripe\StripeObject $bbpos_wisepos_e
 ...
 * @property null|\StoreEngine\Stripe\StripeObject $offline
 * @property null|\StoreEngine\Stripe\StripeObject $reboot_window
 * @property null|\StoreEngine\Stripe\StripeObject $stripe_s700
 * @property null|\StoreEngine\Stripe\StripeObject $tipping
 * @property null|\StoreEngine\Stripe\StripeObject $verifone_p400
 *
 * @license MIT
...
class Configuration extends \StoreEngine\Stripe\ApiResource
{
     ...
     *
     * @return \StoreEngine\Stripe\Terminal\Configuration the created resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Terminal\Configuration the deleted resource
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Terminal\Configuration> of ApiResources
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Terminal\Configuration the updated resource
     */
