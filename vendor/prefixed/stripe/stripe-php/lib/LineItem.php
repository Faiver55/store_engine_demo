 ...
 * @property null|\StoreEngine\Stripe\StripeObject[] $discounts The discounts applied to the line item.
 * @property null|\StoreEngine\Stripe\Price $price The price used to generate the line item.
 * @property null|int $quantity The quantity of products being purchased.
 * @property null|\StoreEngine\Stripe\StripeObject[] $taxes The taxes applied to the line item.
 *
 * @license MIT
