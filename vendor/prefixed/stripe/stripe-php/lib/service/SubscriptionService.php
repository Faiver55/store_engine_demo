 ...
 */
class SubscriptionService extends \StoreEngine\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \StoreEngine\Stripe\Collection<\Stripe\Subscription>
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\Subscription
     */
     ...
     * @throws \StoreEngine\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StoreEngine\Stripe\SearchResult<\Stripe\Subscription>
     */
