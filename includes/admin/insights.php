...
class Insights {
	...
	public function maybe_show_optin() {
		...
		$install_time = get_option('storeengine_first_install_time');
		$current_time = \StoreEngine\Utils\Helper::get_time();
		...
		echo '<div class="notice notice-info" style="padding:0;border-top:0;border-right:0;border-bottom:0;margin:1rem; display: flex; border-left-color: #008dff;">
            <div style="padding: 24px; background: #E0F1FF; display:flex; flex-direction: column; justify-content:center; align-item: center;">
				<img src="' . esc_url( STOREENGINE_ASSETS_URI . 'images/logo.svg' ) . '" width="100" alt="logo" style="margin-bottom: 20px;" />
				<p>Build connections with <br />eCommerce experts.</p>
				<a href="https://www.facebook.com/groups/1689587158579792" target="_blank" style="color: #008dff;">Join the community</a>
			</div>
            <div style="padding: 24px;">
				<h2 style="margin-top: 0; font-size: 20x; font-weight:bold; color: #1E1E1E;"> 💌 Help Us Improve & Get Exclusive Perks!</h2>
				<p>
					We’d love to stay in touch and share helpful updates, tips, and special offers to make the most of <strong>StoreEngine</strong>. Your privacy is our priority. No spam — ever.
				</p>
				<ul>
